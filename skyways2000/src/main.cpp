...
//cubeMaptexture[0] = new CubemapTexture("../Textures/mp_bloodvalley", "blood-valley_ft.tga", "blood-valley_bk.tga", "blood-valley_up.tga", "blood-valley_dn.tga", "blood-valley_rt.tga", "blood-valley_lf.tga");
//cubeMaptexture[1] = new CubemapTexture("../Textures/darkskies", "darkskies_ft.tga", "darkskies_bk.tga", "darkskies_up.tga", "darkskies_dn.tga", "darkskies_rt.tga", "darkskies_lf.tga");
...
//
//if (FT_New_Face(library, "/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf", 0, &face) == FT_Err_Unknown_File_Format)
